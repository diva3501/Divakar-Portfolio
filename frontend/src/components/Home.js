        ...
        <div className="home wlcm-page" id="wlcm">
            <div className="w-l-sec">
                <div className="cont-box1">
                    ...
                    <p style={{ color: "gray", width: "80%", fontSize:"20px", fontFamily:"initial" }}>
                        As a passionate tech enthusiast, I'm on a journey to explore a myriad of stacks, 
                        ...
                        I'm committed to leveraging technology to make a meaningful impact in our ever-evolving digital landscape.
                    </p>
